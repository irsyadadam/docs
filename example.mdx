...
<Info>
  **Attribution:** Events are from the MIMIC-IV Clinical Database Demo converted to MEDS 
  ...
  [van de Water et al. (2025). MIMIC-IV demo data in the Medical Event Data Standard (MEDS) (version 0.0.1). PhysioNet. RRID:SCR_007345.](https://doi.org/10.13026/t2y8-ea41)
