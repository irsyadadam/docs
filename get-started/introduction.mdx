...
**New Release:** [Standard Model v1](/models/standard-model-v1) is now available — our flagship multimodal foundation model for oncology built on Joint-Embedding Predictive Architecture (JEPA).
