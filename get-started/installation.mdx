...
This guide walks you through setting up your environment, downloading [SMB-v1-Structure](/models/standard-model-v1) — our flagship JEPA-based multimodal foundation model for oncology — and applying the model on some data.
