...
This guide walks you through how to set up your environment, download [SMB-v1-Structure](/models/standard-model-v1) (our flagship JEPA-based multimodal foundation model), extract patient embeddings from dummy data, and train classifiers on embeddings.
...
<CardGroup cols={2}>
  ...
  <Card title="Out of Memory" icon="memory">
    SMB-v1-Structure requires ~16GB GPU memory. Reduce memory use via `torch.float16` or quantization (see below).
  </Card>
