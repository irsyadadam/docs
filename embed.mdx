---
title: "Extract patient embeddings"
icon: "code"
---

This guide shows how to extract patient embeddings from MEDS-formatted electronic health record data using `SMB-v1-Structure`.
