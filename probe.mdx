...
This guide explains how to train a linear classifier on top of frozen patient embeddings. This approach is fast, requires minimal data, and evaluates the quality of learned representations.
