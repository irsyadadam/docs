...
description: "Biological world models for patient trajectory prediction"
icon: "brain-circuit"
---
...
SMB-v1-Structure is our flagship biological world model. Unlike traditional LLMs that predict tokens, it predicts **patient states** in latent space, modeling how patients evolve over time given interventions.
