...
<Tip>After running the quickstart script, skip ahead to <a href="#verify-your-installation">Verify Your Installation</a> to confirm everything is working.</Tip>
...
<Columns cols={2}>
  <Card title="Try a full example with synthetic data" icon="sparkles" href="https://docs.standardmodel.bio/example">
    
  </Card>
  <Card title="Use the model on your own data" icon="sparkles" href="https://docs.standardmodel.bio/your-own-data">
