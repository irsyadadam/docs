...
<Columns cols={2}>
  <Card title="Run the Standard Model in a full example" icon="sparkles" href="https://docs.standardmodel.bio/example" cta="Click here to get started!">
    We provide an end-to-end example using the Standard Model to go from raw data to clinical insight.
  </Card>
  <Card title="Run the Standard Model on your own data" icon="sparkles" href="https://docs.standardmodel.bio/your-own-data">
    This guide explains how to leverage the Standard Model on your own EHR data.
  </Card>
</Columns>