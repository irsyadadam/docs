...
<Columns cols={2}>
  <Card title="Run the Standard Model in a full example" icon="sparkles" href="https://docs.standardmodel.bio/example" cta="Click here to get started!">
    We provide [quickstart-pipeline.py](http://quickstart-pipeline.py) demonstrating an end-to-end workflow using the Standard Model to go from raw data to clinical insight.
  </Card>
