...
<Note>
This quickstart uses [uv](https://docs.astral.sh/uv/) for dependency management. If you prefer a different tool (conda, pip, etc.), refer to `pyproject.toml` in the quickstart repo for the list of dependencies.
</Note>
