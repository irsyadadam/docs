...
Standard Model v1 is our flagship biological world model. Unlike traditional LLMs that predict tokens, it predicts **patient states** — modeling how patients evolve over time given interventions.
...
│                            ▼                                    │
│    ┌────────────┐   ┌─────────────┐   ┌────────────────┐       │
│    │ State S(t) │ + │Intervention │ → │ State Predictor│       │
│    └────────────┘   │    A(t)     │   └───────┬────────┘       │
│                     └─────────────┘           ▼                 │
│                                      ┌────────────────┐         │
│                                      │ State S(t+1)   │         │
...
Standard Model v1 requires approximately 16GB GPU memory at full precision. Use these techniques to reduce memory:
...
Read the announcement blog post explaining the motivation and architecture behind Standard Model v1.
